...
func (b *BeaconNode) registerP2P(cliCtx *cli.Context) error {
	...
	svc, err := p2p.NewService(b.ctx, &p2p.Config{
		...
		InstrumentFile:          cliCtx.String(cmd.P2PInstrumentFile.Name),
		InstrumentSocket:        cliCtx.String(cmd.P2PInstrumentSocket.Name),
		InstrumentWaitForAttach: cliCtx.Bool(cmd.P2PInstrumentWaitForAttach.Name),
	})
	if err != nil {
		return err
	}
